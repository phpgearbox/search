 ...
 * 
 * For original class see:
 * http://tartarus.org/martin/PorterStemmer/php.txt
 */

class Stemmer implements Processor
{
	/**
	 ...
	 * Method: process
	 * =========================================================================
	 * This is the only thing we have really modifed in this class.
	 * As Richard says, Stems a word. Simple huh?
	 * 
	 * Parameters:
	 * -------------------------------------------------------------------------
	 * 	- $input: An array of tokens, passed down through the pipeline.
	 * 
	 * Returns:
	 * -------------------------------------------------------------------------
